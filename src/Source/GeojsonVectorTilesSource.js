...
/**
 * @classdesc
 * GeojsonVectorTilesSource are object containing informations on how to fetch vector tiles resources.
 *
 ...
 *
 */
class GeojsonVectorTilesSource extends TMSSource {
    /**
     * @param {Object} source - An object that can contain all properties of a
     * GeojsonVectorTilesSource and {@link Source}.
     *
     * @constructor
     */
    constructor(source) {
        ...
        if (source.style) {
            ...
            // throw new Error('New GeojsonVectorTilesSource: style is required');
        }
        if (source.sprite) {
...
export default GeojsonVectorTilesSource;
